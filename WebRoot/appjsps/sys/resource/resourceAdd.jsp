  ...
  <head>
    	...
    	<form id="addResourceForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
			        ...
			        <td class="alt">
			           <input style="height: 20" name="resourceName" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">资源描述:</td>
			        <td class="alt">
			           <input style="height: 20" name="resourceAlias" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">资源请求路径:</td>
			        <td class="alt">
			           <input style="height: 20" name="resourceUrl" class="text w150" type="text" />
			        </td>
				</tr>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#addResourceForm').form({
				url : 'insertResource.action?parentId=<%=parentId%>',
				onSubmit : function(){
				},
