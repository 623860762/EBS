  ...
  <head>
    	...
    	<form id="addUserForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
			        ...
			        <td class="alt">
			           <input style="height: 20" name="userName" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">用户密码:</td>
			        <td class="alt">
			           <input style="height: 20" name="password" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">用户电子邮件:</td>
			        <td class="alt">
			           <input style="height: 20" name="email" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">MSN帐号:</td>
			        <td class="alt">
			           <input style="height: 20" name="msn" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">QQ帐号:</td>
			        <td class="alt">
			           <input style="height: 20" name="qq" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">手机号:</td>
			        <td class="alt">
			           <input style="height: 20" name="mobile" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">固话号:</td>
			        <td class="alt">
			           <input style="height: 20" name="telephone" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
			    	<td class="table_td1">备注:</td>
			    	<td >
			    		<textarea name="comment" style="height:70px;width:550px;" class="text w150">
			    		</textarea>
			    	</td>
			    </tr>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#addUserForm').form({
				url : 'insertUser.action?parentId=<%=parentId%>',
				onSubmit : function(){
				},
