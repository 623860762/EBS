...
<html>
  <head>
    ...
    <body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    	<form id="updateFunctionForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
					<td class="table_td1">模块名:</td>
			        <td class="alt">
			           <input style="height: 20" name="name" value="<%=sysFunctionVo.getName() == null ? "" : sysFunctionVo.getName() %>" class="text w150" type="text" />
			        </td>
				</tr>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#updateFunctionForm').form({
				url : 'updateFunctionById.action',
				onSubmit : function(){
				},
