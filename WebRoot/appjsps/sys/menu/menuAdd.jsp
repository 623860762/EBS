    	...
    	<form id="insertMenuForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
			        ...
			        <td class="alt">
			           <input style="height: 20" name="name" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">目标(url):</td>
			        <td class="alt">
			           <input style="height: 20" name="linkValue"  class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
			    	<td class="table_td1">备注:</td>
			    	<td >
			    		<textarea name="comments"  style="height:70px;width:550px;" class="text w150">
			    		</textarea>
			    	</td>
			    </tr>
	...
	<script type="text/javascript">
		$(function(){
			$("#save").click(
				function(){
					if(confirm("是否确定增加？")){
						$("#insertMenuForm").submit();
					}
				}
			);
			$('#insertMenuForm').form({
				url : "insertMenu.action?parentId=<%=parentId%>",
				onSubmit : function(){
				},
