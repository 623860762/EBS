  ...
  <head>
    	...
    	<form id="addModuleForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
			        ...
			        <td class="alt">
			           <input style="height: 20" name="moduleName" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">是否为叶子模块:</td>
			        <td class="alt">
			           <input style="height: 20" name="isLeaf"  class="text w150" type="text" />
			        </td>
				</tr>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#addModuleForm').form({
				url : 'insertModule.action?parentId=<%=parentId%>',
				onSubmit : function(){
				},
