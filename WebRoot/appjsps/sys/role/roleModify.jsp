    	...
    	<form id="updateRoleForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
			        ...
			        <td class="alt">
			           <input style="height: 20" name="roleName" value="<%=sysRoleVo.getRoleName() == null ? "" : sysRoleVo.getRoleName() %>" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">角色别名:</td>
			        <td class="alt">
			           <input style="height: 20" name="roleAlias" value="<%=sysRoleVo.getRoleAlias() == null ? "" : sysRoleVo.getRoleAlias() %>" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
			    	<td class="table_td1">备注:</td>
			    	<td >
			    		<textarea name="comment" style="height:70px;width:550px;" class="text w150"><%=sysRoleVo.getComment() == null ? " " : sysRoleVo.getComment() %></textarea>
			    	</td>
			    </tr>
