  ...
  <head>
    	...
    	<form id="addRoleForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
			        ...
			        <td class="alt">
			           <input style="height: 20" name="roleName" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">角色别名:</td>
			        <td class="alt">
			           <input style="height: 20" name="roleAlias" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#addRoleForm').form({
				url : 'insertRole.action?parentId=<%=parentId%>',
				onSubmit : function(){
				},
