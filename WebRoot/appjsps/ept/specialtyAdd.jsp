...
<html>
  <head>
    ...
    <body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    	...
    	<form id="insertSpecialtyForm" method="post">
			<table class="table_common"  align="center" width="800px">
				<tr>
					<td class="table_td1">专业名称:</td>
			        <td class="alt">
			           <input style="height: 20" name="specialtyName" class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
					<td class="table_td1">专业编码:</td>
			        <td class="alt">
			           <input style="height: 20" name="specialtyCode"  class="text w150" type="text" />
			        </td>
				</tr>
				<tr>
			    	<td class="table_td1">专业备注:</td>
			    	<td >
			    		<textarea name="specialtyRemark"  style="height:70px;width:550px;" class="text w150">
			    		</textarea>
			    	</td>
			    </tr>
	...
	<script type="text/javascript">
		$(function(){
			$("#save").click(
				function(){
					if(confirm("是否确定增加？")){
						$("#insertSpecialtyForm").submit();
					}
				}
			);
			$('#insertSpecialtyForm').form({
				url : "insertSpecialty.action?parentId=<%=parentId%>",
				onSubmit : function(){
				},
