  ...
  <body>
    ...
    <form id="showEbeFileClrfy" method="post" >
		...
		<table class="table_common"  class="easyui-datagrid" center" width="800px">
        	...
        	<tr>
        		<td class="table_td1">澄清内容:</td><td><input value="<%=ebeFileClrfyVo.getContent()==null?"":ebeFileClrfyVo.getContent() %>" style="height:50px"  class="easyui-validatebox text w150" data-options="novalidate = true" readonly="true"></td>
        	</tr>
