   			...
   			<form id="dividepackageform" method="post">
   				<table align="left">
   					<tr align="center">
   						...
   						<td><input id="objectid" name="objectid" value=<%=objectid %>  style="display:none;" type="text"></td>
		...
		$(function(){
			$("#subform").click(
				...
				$('#dividepackageform').form({
					url : 'dividePackageInObject.action',
					onSubmit : function(){
					},
				...
				$('#package').datagrid({ 
				    url:'getPackageByObjectId.action?objectid='+pid,  
				    title:'标分包管理>>' ,
				    rownumbers:true,
				    pagination:true,
					fitColumns: true,
