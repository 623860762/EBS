...
<html>
  ...
  <body>
	...
	<tr>
    	<td class="table_td1">属性编码:</td><td><input class="easyui-validatebox title_input" type="text" name="code"></input><font class="need_color">*</font></td>
    </tr>
	<tr>
    	<td class="table_td1">属性名称:</td><td><input class="easyui-validatebox title_input" type="text" name="name"></input><font class="need_color">*</font></td>
    </tr>
	<tr>
    	<td class="table_td1">属性别名:</td><td><input class="easyui-validatebox title_input" type="text" name="aliasName"></input><font class="need_color">*</font></td>
    </tr>
    	<td colspan="2">
...
<script>
	$(function(){
		...
		$('#featPersist').form({
		url:'persistFeat.action?categoryId=<%=categoryId%>',
		dataType:"json",
		onSubmit:function(){
