...
<body>
	...
	<tr>
    	...
    	<td class="table_td1">物料描述:</td><td><input class="easyui-validatebox title_input" type="text" name="wallLocation"></input><font class="need_color">*</font></td>
    </tr>
	<tr>
    	<td class="table_td1">来源:</td><td><input class="easyui-validatebox title_input" type="text" name="wallName"></input><font class="need_color">*</font></td>
    	<td class="table_td1">备注:</td><td><input class="easyui-validatebox title_input" type="text" name="wallLocation"></input><font class="need_color">*</font></td>
    </tr>
	<tr>
    	<td class="table_td1">计量单位:</td><td><input class="easyui-validatebox title_input" type="text" name="wallOwer"></input><font class="need_color">*</font></td>
    	<td colspan="2"></td>
    </tr>
    <tr>
    	...
    	for(int i = 0;i<list.size();i++){%>
        		<ul class="feat_ul">
        			...
        			<li class="feat_ul_li2">
        				<input name="featNAME<%=i %>"  value="" type="text"/><font class="need_color">*</font>
