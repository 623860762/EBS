...
public class CntContractSellerVo implements java.io.Serializable {
	...
	// Constructors
	public CntContractSellerVo(CntContractSeller p) {
		this.setIsValid(p.getIsValid());
		this.setOpTime(p.getOpTime());
		this.setId(p.getId());
		this.setSupplierAccount(p.getSupplierAccount());
		this.setSupplierBank(p.getSupplierBank());
		this.setSupplierBankAddr(p.getSupplierBankAddr());
		this.setSupplierEmail(p.getSupplierEmail());
		this.setSupplierId(p.getSupplierId());
		this.setSupplierMdmNo(p.getSupplierMdmNo());
		this.setSupplierName(p.getSupplierName());
		this.setSupplierPhone(p.getSupplierPurchaser());
		this.setSupplierPurchaser(p.getSupplierPurchaser());
		this.setDispIndex(p.getDispIndex());
	}
	
	public CntContractSeller adapterToCntContractSeller(){
		CntContractSeller p = new CntContractSeller();
		p.setIsValid(this.getIsValid());
		p.setOpTime(this.getOpTime());
		p.setId(this.getId());
		p.setSupplierAccount(this.getSupplierAccount());
		p.setSupplierBank(this.getSupplierBank());
		p.setSupplierBankAddr(this.getSupplierBankAddr());
		p.setSupplierEmail(this.getSupplierEmail());
		p.setSupplierId(this.getSupplierId());
		p.setSupplierMdmNo(this.getSupplierMdmNo());
		p.setSupplierName(this.getSupplierName());
		p.setSupplierPhone(this.getSupplierPurchaser());
		p.setSupplierPurchaser(this.getSupplierPurchaser());
	...
	/** default constructor */
	public CntContractSellerVo() {
	}

	/** minimal constructor */
	public CntContractSellerVo(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public CntContractSellerVo(Integer id, Integer supplierId, String supplierMdmNo,
