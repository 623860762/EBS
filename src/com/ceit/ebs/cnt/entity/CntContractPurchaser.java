...
public class CntContractPurchaser implements java.io.Serializable {
	...
	/** default constructor */
	public CntContractPurchaser() {
	}

	/** minimal constructor */
	public CntContractPurchaser(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public CntContractPurchaser(Integer id, String purchaserCode,
